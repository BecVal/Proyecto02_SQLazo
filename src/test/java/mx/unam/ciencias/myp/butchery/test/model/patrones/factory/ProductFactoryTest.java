...
/**
 * Pruebas unitarias para la clase {@link ProductFactory}.
 * <p>
 * Se valida que la fábrica:
 * <ul>
 *     <li>Construya correctamente productos por unidad.</li>
 *     <li>Construya correctamente productos por peso.</li>
 *     <li>Genere productos por defecto cuando solo se proporciona el ID y el tipo.</li>
 * </ul>
 * </p>
 */
public class ProductFactoryTest {
    /**
     * Verifica que {@link ProductFactory#createProduct(String, ProductFactory.ProductType, String, double)} cree correctamente un {@link ProductByUnit} con los atributos adecuados.
     */
    @Test
    ...
    /**
     * Verifica que {@link ProductFactory#createProduct(String, ProductFactory.ProductType, String, double)} cree correctamente un {@link ProductByWeight} con los atributos correspondientes.
     */
    @Test
    ...
    /**
     * Verifica que la versión simplificada del método {@link ProductFactory#createProduct(String, ProductFactory.ProductType)} genere un producto válido usando valores por defecto:
     * 
     * <ul>
     *     <li>El nombre es igual al ID.</li>
     *     <li>El precio inicial es 0.0.</li>
     *     <li>El tipo indicado se respeta.</li>
     * </ul>
     * 
     */
    @Test
